    ...
    <body>
            <div id="HE">
                <div id="CHE" class="CS">
                    ...
                    <div id="NUSER">
                    	<div><img src="../img/05.png">Usuario</div>
                    </div>
                </div>
            </div>
            <div id="SE">
            ...
            <div class="CS" id="COT" align="center">
            	
                <div class="PGO MC">
                    <div id="TTPGOPC">
                        <img id="IPPP" src="../img/S1OP1.png">
                        <div id="TTTXT"><?php echo  substr(namePages(),-5,5); ?></div>
                        <div id="BTRGRS" title="Cerrar">
                            <a href="../inicio.php" id="CRRPPP"><img src="../img/BL-3-2.png"></a>
                        </div>
                    </div>              	
                    <div id="CTPG">
